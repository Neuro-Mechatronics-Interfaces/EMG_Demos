...
class MyApp(QMainWindow):
    def __init__(self, sensor, window_size=200, step_size=100):
        super().__init__()
        ...
        default_filename = f"data/{today_str}"  
        default_MVC_Baseline = "[0,0,0,0,0,0,0,0]"
        ...
        self.Baseline_input = QLineEdit(default_MVC_Baseline)
        self.left_layout.addWidget(self.Baseline_input)
        
        self.left_layout.addWidget(QLabel("MVC:"))
        self.mvc_input = QLineEdit(default_MVC_Baseline)
        ...
        self.mvc_input.textChanged.connect(self.on_calibrate_click)
